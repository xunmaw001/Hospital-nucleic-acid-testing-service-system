...
public class JiezhongdingdanEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JiezhongdingdanEntity() {
		
	}
	
	public JiezhongdingdanEntity(T t) {
		try {
	 ...
	 * 设置：接种余位
	 */
	public void setJiezhongyuwei(String jiezhongyuwei) {
		this.jiezhongyuwei = jiezhongyuwei;
	}
	/**
	 * 获取：接种余位
	 */
	public String getJiezhongyuwei() {
