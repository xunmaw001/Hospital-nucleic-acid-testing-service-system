  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="身份证号" prop="shenfenzhenghao">
              <el-input v-model="ruleForm.shenfenzhenghao" 
                placeholder="身份证号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="检测点名称" prop="jiancedianmingcheng">
          <el-input v-model="ruleForm.jiancedianmingcheng" 
              placeholder="检测点名称" clearable  :readonly="ro.jiancedianmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="检测点名称" prop="jiancedianmingcheng">
              <el-input v-model="ruleForm.jiancedianmingcheng" 
                placeholder="检测点名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="检测费用" prop="jiancefeiyong">
              <el-input v-model="ruleForm.jiancefeiyong" 
                placeholder="检测费用" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="检测点" prop="jiancedian">
          <el-input v-model="ruleForm.jiancedian" 
              placeholder="检测点" clearable  :readonly="ro.jiancedian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="检测点" prop="jiancedian">
              <el-input v-model="ruleForm.jiancedian" 
          ...
          <el-form-item class="input" label="地区" prop="diqu">
              <el-input v-model="ruleForm.diqu" 
                placeholder="地区" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="检测余位" prop="jianceyuwei">
          <el-select v-model="ruleForm.jianceyuwei" placeholder="请选择检测余位">
            <el-option
                v-for="(item,index) in jianceyuweiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="检测余位" prop="jianceyuwei">
	      <el-input v-model="ruleForm.jianceyuwei"
                placeholder="检测余位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.userid = true;
            continue;
                                                                                                                                                        ...
                                                                                                                                                        this.ruleForm.jianceyuwei = 0
	this.ro.jianceyuwei = false;
                                                                                                                                      }
            // 获取用户信息
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                                                                          ...
                                                                                                                                                                                          this.jianceyuweiOptions = "1".split(',')
                                                                                                                                                          },
                                                                                                                                        // 多级联动参数
                                                                                                                                                                            info(id) {
      this.$http({
        url: `jiancedingdan/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      obj.jianceyuwei = obj.jianceyuwei - this.ruleForm.jianceyuwei
      if(obj.jianceyuwei<0){
        this.$message.error("检测余位不足");
        return
      }
      this.$http({
          url: `${table}/update`,
        ...
        if (valid) {
          this.$http({
            url: `jiancedingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiancedingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
