  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="接种费用" prop="jiezhongfeiyong">
              <el-input v-model="ruleForm.jiezhongfeiyong" 
                placeholder="接种费用" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接种余位" prop="jiezhongyuwei">
          <el-input v-model="ruleForm.jiezhongyuwei" 
              placeholder="接种余位" clearable  :readonly="ro.jiezhongyuwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接种余位" prop="jiezhongyuwei">
              <el-input v-model="ruleForm.jiezhongyuwei" 
                placeholder="接种余位" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="医护工号" prop="yihugonghao">
          <el-select  @change="yihugonghaoChange" v-model="ruleForm.yihugonghao" placeholder="请选择医护工号">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.yihugonghao" label="医护工号" prop="yihugonghao">
...
export default {
  data() {
	...
	jieshushijian : false,
            ...
            ruleForm: {
                  ...
                  jiezhongyuwei: [
                            { required: true, message: '接种余位不能为空', trigger: 'blur' },
                                        { validator: validateIntNumber, trigger: 'blur' },
                        	                                                              ],
                  yihugonghao: [
                                    	                                                              ],
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yimiaojiezhong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yimiaojiezhongCrossAddOrUpdateFlag = false;
                  this.parent.search();
