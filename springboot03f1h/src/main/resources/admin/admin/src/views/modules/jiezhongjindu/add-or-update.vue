  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="用户姓名" prop="yonghuxingming">
              <el-input v-model="ruleForm.yonghuxingming" 
                placeholder="用户姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="身份账号" prop="shenfenzhanghao">
          <el-input v-model="ruleForm.shenfenzhanghao" 
              placeholder="身份账号" clearable  :readonly="ro.shenfenzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="身份账号" prop="shenfenzhanghao">
              <el-input v-model="ruleForm.shenfenzhanghao" 
                placeholder="身份账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="地区" prop="diqu">
              <el-input v-model="ruleForm.diqu" 
                placeholder="地区" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="进度" prop="jindu">
          <el-select v-model="ruleForm.jindu" placeholder="请选择进度">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="进度" prop="jindu">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jiezhongjindu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiezhongjinduCrossAddOrUpdateFlag = false;
                  this.parent.search();
