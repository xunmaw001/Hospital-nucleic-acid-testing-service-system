<template>
  <div class="main-content">
    ...
    <add-or-update v-if="addOrUpdateFlag" :parent="this" ref="addOrUpdate"></add-or-update>
      ...
      width="800">
                                                                                                                                                    <div id="diquChart" style="width:100%;height:600px;"></div>
...
export default {
  ...
  methods: {
    ...
    contentPageStyleChange(){
      ...
      this.$nextTick(()=>{
                                                                                                                                                                                                                                                                          var diquChart = this.$echarts.init(document.getElementById("diquChart"),'macarons');
        this.$http({
            url: "group/yonghu/diqu",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
            let res = data.data;
