          ...
          <el-form-item class="input" label="地区" prop="diqu">
              <el-input v-model="ruleForm.diqu" 
                placeholder="地区" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="更新时间" prop="gengxinshijian">
          <el-input v-model="ruleForm.gengxinshijian" 
              placeholder="更新时间" clearable  :readonly="ro.gengxinshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="更新时间" prop="gengxinshijian">
              <el-input v-model="ruleForm.gengxinshijian" 
...
export default {
  ...
  methods: {
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                        ...
                                                                        // 多级联动参数
                                                                                            info(id) {
      this.$http({
        url: `hesuanjiancezhengming/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `hesuanjiancezhengming/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.hesuanjiancezhengmingCrossAddOrUpdateFlag = false;
                  this.parent.search();
