          ...
          <el-form-item class="input" label="用户手机" prop="yonghushouji">
              <el-input v-model="ruleForm.yonghushouji" 
                placeholder="用户手机" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="近期旅居史" prop="jinqilvjushi">
          <el-input v-model="ruleForm.jinqilvjushi" 
              placeholder="近期旅居史" clearable  :readonly="ro.jinqilvjushi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="近期旅居史" prop="jinqilvjushi">
              <el-input v-model="ruleForm.jinqilvjushi" 
                placeholder="近期旅居史" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="地区" prop="diqu">
              <el-input v-model="ruleForm.diqu" 
                placeholder="地区" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="目前所在地" prop="muqiansuozaidi">
          <el-input v-model="ruleForm.muqiansuozaidi" 
              placeholder="目前所在地" clearable  :readonly="ro.muqiansuozaidi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="目前所在地" prop="muqiansuozaidi">
              <el-input v-model="ruleForm.muqiansuozaidi" 
                placeholder="目前所在地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yonghushouji = true;
            continue;
	            	            ...
	            	            if(o=='jinqilvjushi'){
            this.ruleForm.jinqilvjushi = obj[o];
	    this.ro.jinqilvjushi = true;
            continue;
          }
	    ...
	    this.ro.diqu = true;
            continue;
	            	            ...
	            	            if(o=='muqiansuozaidi'){
            this.ruleForm.muqiansuozaidi = obj[o];
	    this.ro.muqiansuozaidi = true;
            continue;
          }
