          ...
          <el-form-item class="input" label="地区" prop="diqu">
              <el-input v-model="ruleForm.diqu" 
                placeholder="地区" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="检测余位" prop="jianceyuwei">
          <el-input v-model="ruleForm.jianceyuwei" 
              placeholder="检测余位" clearable  :readonly="ro.jianceyuwei"></el-input>
        </el-form-item>
        <div v-else>
  ...
  data() {
	...
	shuoming : false,
            ...
            ruleForm: {
                  ...
                  jianceyuwei: [
                            { required: true, message: '检测余位不能为空', trigger: 'blur' },
                                        { validator: validateIntNumber, trigger: 'blur' },
                        	                                                              ],
                  yihugonghao: [
                                    	                                                              ],
