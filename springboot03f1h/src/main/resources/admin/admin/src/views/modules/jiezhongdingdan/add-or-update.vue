  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="身份证号" prop="shenfenzhenghao">
              <el-input v-model="ruleForm.shenfenzhenghao" 
                placeholder="身份证号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接种点名称" prop="jiezhongdianmingcheng">
          <el-input v-model="ruleForm.jiezhongdianmingcheng" 
              placeholder="接种点名称" clearable  :readonly="ro.jiezhongdianmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接种点名称" prop="jiezhongdianmingcheng">
              <el-input v-model="ruleForm.jiezhongdianmingcheng" 
                placeholder="接种点名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="接种费用" prop="jiezhongfeiyong">
              <el-input v-model="ruleForm.jiezhongfeiyong" 
                placeholder="接种费用" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接种点" prop="jiezhongdian">
          <el-input v-model="ruleForm.jiezhongdian" 
              placeholder="接种点" clearable  :readonly="ro.jiezhongdian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接种点" prop="jiezhongdian">
              <el-input v-model="ruleForm.jiezhongdian" 
                placeholder="接种点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="地区" prop="diqu">
              <el-input v-model="ruleForm.diqu" 
                placeholder="地区" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="接种余位" prop="jiezhongyuwei">
          <el-select v-model="ruleForm.jiezhongyuwei" placeholder="请选择接种余位">
            <el-option
                v-for="(item,index) in jiezhongyuweiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="接种余位" prop="jiezhongyuwei">
	      <el-input v-model="ruleForm.jiezhongyuwei"
                placeholder="接种余位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.shenfenzhenghao = json.shenfenzhenghao
                                                                                                    		...
                                                                                                    		if(json.diqu!=''&&json.diqu){
              		this.ruleForm.diqu = json.diqu
		}
                                                                                                                                                                                                              } else {
    ...
    onSubmit() {
      ...
      this.$http({
        ...
        if (valid) {
          this.$http({
            url: `jiezhongdingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jiezhongdingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
