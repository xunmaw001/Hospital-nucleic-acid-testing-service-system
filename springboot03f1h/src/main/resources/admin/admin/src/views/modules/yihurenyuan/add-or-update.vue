          ...
          <el-form-item class="input" label="年龄" prop="nianling">
              <el-input v-model="ruleForm.nianling" 
                placeholder="年龄" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.yihuzhaopian" label="医护照片" prop="yihuzhaopian">
          <file-upload
          tip="点击上传医护照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.yihuzhaopian?ruleForm.yihuzhaopian:''"
          @change="yihuzhaopianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.yihuzhaopian" label="医护照片" prop="yihuzhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yihuzhaopian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                ...
                this.ruleForm.yihuzhaopian = fileUrls;
				this.addEditUploadStyleChange()
            },
            	addEditStyleChange() {
	  this.$nextTick(()=>{
