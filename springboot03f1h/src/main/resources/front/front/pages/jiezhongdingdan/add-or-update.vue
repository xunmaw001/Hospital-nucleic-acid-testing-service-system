	...
	<view class="content">
		<form class="app-update-pv">
				...
				<input :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","borderColor":"rgba(215, 215, 215, 1)","borderRadius":"0px","color":"rgba(255, 144, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' :disabled="ro.shenfenzhenghao" v-model="ruleForm.shenfenzhenghao" placeholder="身份证号"></input>
												...
												<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"rgba(240, 239, 239, 1)","margin":"0","borderWidth":"0 0 2rpx 0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(147, 193, 7, 1)","textAlign":"left"}' class="title">接种点名称</view>
				<input :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","borderColor":"rgba(215, 215, 215, 1)","borderRadius":"0px","color":"rgba(255, 144, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' :disabled="ro.jiezhongdianmingcheng" v-model="ruleForm.jiezhongdianmingcheng" placeholder="接种点名称"></input>
			</view>
												<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"rgba(240, 239, 239, 1)","margin":"0","borderWidth":"0 0 2rpx 0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(147, 193, 7, 1)","textAlign":"left"}' class="title">接种费用</view>
				<input :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","borderColor":"rgba(215, 215, 215, 1)","borderRadius":"0px","color":"rgba(255, 144, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' :disabled="ro.jiezhongfeiyong" v-model="ruleForm.jiezhongfeiyong" placeholder="接种费用"></input>
			</view>
												<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"rgba(240, 239, 239, 1)","margin":"0","borderWidth":"0 0 2rpx 0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(147, 193, 7, 1)","textAlign":"left"}' class="title">接种点</view>
				<input :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","borderColor":"rgba(215, 215, 215, 1)","borderRadius":"0px","color":"rgba(255, 144, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' :disabled="ro.jiezhongdian" v-model="ruleForm.jiezhongdian" placeholder="接种点"></input>
			</view>
												<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"rgba(240, 239, 239, 1)","margin":"0","borderWidth":"0 0 2rpx 0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				...
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(147, 193, 7, 1)","textAlign":"left"}' class="title">接种余位</view>
				<picker @change="jiezhongyuweiChange" :value="jiezhongyuweiIndex" :range="jiezhongyuweiOptions">
					<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(215, 215, 215, 1)","borderRadius":"0px","color":"rgba(255, 144, 0, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.jiezhongyuwei?ruleForm.jiezhongyuwei:"请选择接种余位"}}</view>
				</picker>
			</view>
												<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"rgba(240, 239, 239, 1)","margin":"0","borderWidth":"0 0 2rpx 0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				...
				ruleForm: {
												yuyuebianhao: this.getUUID(),
																...
																userid: '',
																																																																												...
																																																																												jiezhongyuweiOptions: [],
				jiezhongyuweiIndex: 0,
																																																																				// 登陆用户信息
				user: {},
                                ro:{
                                   yuyuebianhao : false,
		...
		async onLoad(options) {
			...
			this.user = res.data;
						...
						// ss读取
												...
												this.ruleForm.shenfenzhenghao = this.user.shenfenzhenghao
																														this.ruleForm.diqu = this.user.diqu
																																																									
																																																												// 自定义下拉框值
			this.jiezhongyuweiOptions = "1".split(',')
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`jiezhongdingdan`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='jiezhongdianmingcheng'){
					this.ruleForm.jiezhongdianmingcheng = obj[o];
					this.ro.jiezhongdianmingcheng = true;
					continue;
					}
					...
					if(o=='jiezhongdian'){
					this.ruleForm.jiezhongdian = obj[o];
					this.ro.jiezhongdian = true;
					continue;
					}
					if(o=='diqu'){
					...
					if(o=='jiezhongyuwei'){
					this.ruleForm.jiezhongyuwei = obj[o];
					this.ro.jiezhongyuwei = true;
					continue;
					}
					if(o=='yuyueshijian'){
				...
				this.ruleForm.jiezhongyuwei = 0;
				this.ro.jiezhongyuwei = false;
			}
			this.styleChange()
		},
		methods: {
			...
			yuyueshijianConfirm(val) {
				...
				this.$forceUpdate();
																																																									...
																																																									// 下拉变化
			jiezhongyuweiChange(e) {
				this.jiezhongyuweiIndex = e.target.value
				this.ruleForm.jiezhongyuwei = this.jiezhongyuweiOptions[this.jiezhongyuweiIndex]
			},
			...
			async onSubmitTap() {
				...
				obj.jiezhongyuwei = obj.jiezhongyuwei - this.ruleForm.jiezhongyuwei
				if(obj.jiezhongyuwei<0){
					this.$utils.msg("接种余位数量不足");
					return
				}
				await this.$api.update(`${table}`, obj);
					...
					return
																																								...
																																								if(this.ruleForm.id){
					await this.$api.update(`jiezhongdingdan`, this.ruleForm);
				}else{
					await this.$api.add(`jiezhongdingdan`, this.ruleForm);
				}
